  ...
  return (
    <>
      <header className="flex items-center justify-between pt-4">
        <div>
          <h2 className="text-[26px] font-semibold tracking-tight">Vocabulary</h2>
      ...
      <button className="mt-5 flex min-h-12 w-full items-center justify-center gap-2 rounded-full bg-primary text-[15px] font-medium text-primary-foreground transition-opacity hover:opacity-90">
          ...
          return (
            ...
            >
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-[11px] font-medium" style={{ color: `var(--${meta.tone})` }}>
                  {meta.label}
                </span>
                {word.source === "mine" && <span className="text-[11px] text-chart-5">mine</span>}
                <span
                  className={cn(
        ...
        <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-label="Add a word">
          ...
          <div className="absolute inset-x-0 bottom-0 rounded-t-3xl border-t border-border bg-popover p-5 pb-[max(env(safe-area-inset-bottom),1.25rem)] shadow-sheet">
            ...
            <button
              ...
              className="mt-3 flex min-h-12 w-full items-center justify-center rounded-full bg-primary text-sm font-medium text-primary-foreground disabled:opacity-40"
            >
              Add to my deck
            </button>
          </div>
